...
public class NewPRBOptionPane extends Dialog implements ActionListener {
    ...
    public NewPRBOptionPane(PRB parent) {
        super((Frame) parent, PRB.MENU_PRB_NEW, true);
        setResizable(false);
        ...
        Label label1 = new Label(
                "Creando un nuovo documento PRB, si perderanno le modifiche");
        add(label1);
