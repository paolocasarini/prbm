...
public class DialogEditIntervista extends Dialog
{
	...
	public DialogEditIntervista(PRB parent,Resource rs)
	{
		...
		icone = (new File(DialogEditIntervista.class.getResource("../../resources/" + icoDir).getFile())).list();
...
/*	public void addNotify()
    ...
    class SymWindow extends java.awt.event.WindowAdapter
	{
		public void windowClosing(java.awt.event.WindowEvent event)
		{
			...
			if (object == DialogEditIntervista.this)
				DialogEditIntervista_WindowClosing(event);
		}
	}
	
	void DialogEditIntervista_WindowClosing(java.awt.event.WindowEvent event)
	{
		setVisible(false);
		dispose();
	}
