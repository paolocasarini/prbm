...
public class DialogEditFauna extends Dialog
{
	...
	public DialogEditFauna(PRB parent,Resource rs)
	{
		...
		icone = (new File(DialogEditFauna.class.getResource("../../resources/" + icoDir).getFile())).list();
...
/*	public void addNotify()
    ...
    class SymWindow extends java.awt.event.WindowAdapter
	{
		public void windowClosing(java.awt.event.WindowEvent event)
		{
			...
			if (object == DialogEditFauna.this)
				DialogEditFauna_WindowClosing(event);
		}
	}
	
	void DialogEditFauna_WindowClosing(java.awt.event.WindowEvent event)
	{
		setVisible(false);
		dispose();
	}
