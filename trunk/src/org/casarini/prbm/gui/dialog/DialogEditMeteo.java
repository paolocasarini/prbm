...
public class DialogEditMeteo extends Dialog
{
	...
	public DialogEditMeteo(PRB parent,Resource rs)
	{
		...
		icone = (new File(DialogEditMeteo.class.getResource("../../resources/" + icoDir).getFile())).list();
...
/*	public void addNotify()
    ...
    class SymWindow extends java.awt.event.WindowAdapter
	{
		public void windowClosing(java.awt.event.WindowEvent event)
		{
			...
			if (object == DialogEditMeteo.this)
				DialogEditMeteo_WindowClosing(event);
		}
	}
	
	void DialogEditMeteo_WindowClosing(java.awt.event.WindowEvent event)
	{
		setVisible(false);
		dispose();
	}
